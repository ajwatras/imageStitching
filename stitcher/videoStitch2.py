...
vidcap1 = cv2.VideoCapture('../data/testVideo/trainer_black_bottom/output1.avi')
vidcap2 = cv2.VideoCapture('../data/testVideo/trainer_black_bottom/output2.avi')
vidcap3 = cv2.VideoCapture('../data/testVideo/trainer_black_bottom/output3.avi')
vidcap4 = cv2.VideoCapture('../data/testVideo/trainer_black_bottom/output4.avi')
