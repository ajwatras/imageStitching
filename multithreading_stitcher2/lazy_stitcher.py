...
warpping_queue = [[Queue.Queue(1), Queue.Queue(1), Queue.Queue(1)], [Queue.LifoQueue(1), Queue.LifoQueue(1), Queue.Queue(1)], [Queue.LifoQueue(1), Queue.LifoQueue(1), Queue.Queue(1)]]
